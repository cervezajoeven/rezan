            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select class="form-control select2 required" name="borrower_id" required="required" style="width: 100%;">
                                ...
                                <?php foreach ($borrowers as $borrower_key => $borrower_value) :?>
                                    <option <?php echo ($loan_data['borrower_id']==$borrower_value['id'])?"selected":""; ?> value="<?php echo $borrower_value['id']; ?>"><?php echo $borrower_value['name']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 required" name="capital_id" required="required" style="width: 100%;">
                                ...
                                <?php foreach ($capitals as $capital_key => $capital_value) :?>
                                    <option <?php echo ($loan_data['capital_id']==$capital_value['id'])?"selected":""; ?> value="<?php echo $capital_value['id']; ?>"><?php echo $capital_value['name']; ?> (₱ <?php echo number_format($capital_value['amount']); ?> / ₱ <?php echo number_format($capital_value['amount']); ?>)</option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            <label>Date</label>
                            <input type="date" value="<?php echo $loan_data['start_date'] ?>" class="form-control start_date" name="start_date" onchange="calculate_deadline();">
                        </div>
                        <div class="form-group">
                            <label>Amount</label>
                            <input type="number" min="100" value="<?php echo $loan_data['amount'] ?>" onkeyup="calculate_gives_payable();calculate_expected_receivable();" class="form-control amount" name="amount">
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" min="1" value="<?php echo $loan_data['percentage'] ?>" onkeyup="calculate_gives_payable();calculate_expected_receivable();" class="form-control percentage" name="percentage">
                        </div>
                        <div class="form-group">
                            <label>Expected Gives per Month</label>
                            <input type="number" onkeyup="calculate_gives();calculate_gives_payable();" placeholder="2" value="<?php echo $loan_data['gives_per_month'] ?>" min="1" class="form-control gives_per_month" name="gives_per_month">
                        </div>
                        <div class="form-group">
                            <label>Expected Term (Months)</label>
                            <input type="number" onkeyup="calculate_deadline();calculate_gives();calculate_gives_payable();calculate_expected_receivable();" placeholder="3" value="<?php echo $loan_data['term'] ?>" class="form-control term" name="term">
                        </div>
                        <div class="form-group">
